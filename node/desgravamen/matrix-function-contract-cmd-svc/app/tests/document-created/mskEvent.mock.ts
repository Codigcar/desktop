...
export const mockMessageTopicOfferAuthorized = () => {
  return {
    source: '4cba3700-7db6-416e-88fb-99f3b16b730f',
    id: 2,
    author: '4cba3700-7db6-416e-88fb-99f3b16b730f',
    data: {
      payload: {
        accountId: 'yyyyyy'
      },
      snapshot: {
        offer: {
          id: 'd85f5dc2-5876-4e47-8328-ff3c63e95951',
          dataProtectionClauseAccepted: true,
          conditions: {
            creditLine: 3000,
            currency: 'PEN'
    ...
    dataEncodingType: 'identity',
    time: 1658294616645,
    transaction: '4cba3700-7db6-416e-88fb-99f3b16b730f',
    type: 'com.gcreditcorp.matrix.contract.offer-authorized',
  };
}
