module "this" {
  ...
  handler          = "functions/rollback/handler.handler"
  runtime          = "nodejs16.x"
  memory_size      = "128"
  timeout          = 60
...
resource "aws_lambda_event_source_mapping" "this1" {
  ...
  topics            = ["com.gcredicorp.matrix.customer.creation-failed.v1"]
...
resource "aws_lambda_event_source_mapping" "this2" {
  event_source_arn  = data.aws_msk_cluster.this.arn
  function_name     = module.this.lambda-function.main.arn
  topics            = ["com.gcredicorp.matrix.card-register.failed.v1"]
  starting_position = "TRIM_HORIZON"
...
resource "aws_lambda_event_source_mapping" "this3" {
  event_source_arn  = data.aws_msk_cluster.this.arn
  function_name     = module.this.lambda-function.main.arn
  topics            = ["com.gcredicorp.matrix.document-template.render-failed.v1"]
  starting_position = "TRIM_HORIZON"
