    ...
    answers: [
      {
        ...
        value: {
          type: 'text',
          body: 'Amiga, ahora, voy a presentarte a mi amiga Sandra. Su bebé tiene anemia y en la posta le recetaron unas gotitas. Sandra es muy responsable y se las dá al pie de la letra. Pero tiene algunas preguntas',
        },
      },
    ],
  },
