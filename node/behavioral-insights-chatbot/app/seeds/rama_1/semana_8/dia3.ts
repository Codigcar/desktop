...
export const SEM8_D3: ISemanas[] = [
  ...
  },
  {
    ...
    value: {
      ...
      type: 'interactive',
      body: 'El viernes pasado me pediste que te recuerde que te habías puesto la meta de buscar adultos de tu confianza o personal médico para contarle los problemas de salud que crees que podrías tener, *{{message}}* ¿lograste cumplirla?\n\nA. Si\nB. No\nC. Más o menos (inicié, pero no terminé)',
      buttons: [
        {
          title: 'A',
        },
