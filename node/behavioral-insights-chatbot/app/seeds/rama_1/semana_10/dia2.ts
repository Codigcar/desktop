    ...
    answers: [
      {
        ...
        value: {
          type: 'text',
          body: 'Cómo vimos el lunes, ser mamá implica varios retos que superar, pero que las cosas no siempre salgan como las esperamos no significa que no seamos buenas mamás',
        },
      },
    ],
  },
    ...
    answers: [
      {
        ...
        value: {
          type: 'text',
          body: 'La información que le dimos a Clarita le ha ayudado mucho a sentirse más tranquila sabiendo qué hacer para superar la anemia de su bebito. Y es normal sentirse preocupada a veces, pero es importante reconocer que eso no nos hace malas mamás',
        },
      },
    ],
  },
