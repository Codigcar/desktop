...
export const SEM10_D3: ISemanas[] = [
  ...
  },
  {
    ...
    value: {
      ...
      body: '¿Te gustaría ponerte el objetivo de hacer alguna actividad con otra amiga durante la semana? ¡Nuestra red de apoyo es muy importante en nuestro rol como madres! Cuéntame cuántas veces te propones realizarlo:',
      sections: [
        {
