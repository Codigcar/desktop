...
export const RAMA4_SEM7_D1: ISemanas[] = [
  {
    category: 'template',
...

  {
    ...
    value: {
      type: 'text',
      body: '2. ¿Qué significa cuando el bebé de Marita se ve así, emocionado, con la boquita abierta, o girando la cabeza como buscando?',
    },
  },
  {
    category: 'info',
