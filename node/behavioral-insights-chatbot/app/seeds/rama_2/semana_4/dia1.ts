...
export const SEM4_D1: ISemanas[] = [
    ...
    answers: [
      {
        ...
        value: {
          type: 'text',
          body: '3. Si la bebé de Luz cumplió hoy 6 meses',
        },
      },
    ],
  },
...

  {
    ...
    value: {
      type: 'interactive',
      body: '4. ¿Debería Luz darle de su propio plato?',
      buttons: [
        {
          title: 'Si',
        },
...

  {
    ...
    value: {
      type: 'interactive',
      body: '5. ¿Le podemos dar a la bebé de Luz comiditas con azúcar o con sal?\n\nA. Sí, pero muy poca cantidad.\nB. Sí, tal cual lo comen los adultos.\nC. No.',
      buttons: [
        {
          title: 'A',
        },
