...
class ExecutiveGroupAdapter : RecyclerView.Adapter<ExecutiveGroupAdapter.ItemViewHolder>() {

    var listGroups: MutableList<ExecutiveGroup>? = null
    ...
    class ItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(group: ExecutiveGroup, onClick: OnClick?) = with(itemView) {
    ...
    interface OnClick {
        fun getGroup(group: ExecutiveGroup)
    }
}
