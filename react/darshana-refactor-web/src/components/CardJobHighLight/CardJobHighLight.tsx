...
const CardJobHighLight: FC<Props> = ({
  title,
  company,
  location,
  showVisible,
  ...
  return (
    <Link href={link}>
      <a className={`card ${styles.cardHighLight} `}>
        <div className={styles.cardHeader}>
          ...
          <div className={styles.HeaderInformation}>
            <h3 className={`text-20 ${styles.title} flex`}>
              <b>{title}</b>{' '}
              <b
                style={{
                  color: '#19A79B',
...
CardJobHighLight.defaultProps = defaultProps;

export default CardJobHighLight;
