...
const SafeArea = App.select({
  elcomercio: <SafeAreaView bg="primary" edges={['top']} />,
  default: null,
})
...
const INJECTED_JAVASCRIPT = `
  ...
  window.__REACT_NATIVE_SCREENS_STORY__ = ${flags.ENABLE_SCREEN_STORY};
  true;
`
