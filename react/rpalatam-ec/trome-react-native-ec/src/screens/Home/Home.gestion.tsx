...
import { Linking, Platform, SectionList, TouchableOpacity } from 'react-native'
        ...
        LeftComponent={() => (
          <TouchableOpacity
            ...
            <View
              ...
              <Icon name="menu" color={colors['coolGray-700']} size={24} />
            </View>
          </TouchableOpacity>
        )}
        RigthComponent={() => {
          return (
            <TouchableOpacity
              ...
              <View
                ...
                alignItems="center"
                justifyContent="center">
                <Icon name="magnify" color={colors['coolGray-700']} size={24} />
              </View>
            </TouchableOpacity>
          )
        }}>
        <View alignItems="center">
          <Logotipo color={colors.badgeFont} height={24} />
        </View>
      </Ribbon>
      <SectionList
        sections={sections}
