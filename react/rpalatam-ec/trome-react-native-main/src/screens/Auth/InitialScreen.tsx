...
const getToken = (provider: SocialMediaProvider): Promise<string> => {
  if (provider === 'apple') {
    return authThirdParty.appleSignIn()
  }

  if (provider === 'facebook') {
    return authThirdParty.facebookSignIn()
  }
...
const InitialScreen: React.FC = () => {
  ...
  const handleSignIn = async (provider: SocialMediaProvider) => {
    try {
          ...
          {!isOAuthAvailable && ENABLE_SOCIAL_MEDIA ? (
            <View
              ...
              <TouchableWithoutFeedback
                ...
                <View mr="1.25">
                  <Icon name="facebook" size={58} color="#1778F2" />
                </View>
              </TouchableWithoutFeedback>
              <TouchableWithoutFeedback
                onPress={() => {
              ...
              <AuthWithApple handleSignIn={handleSignIn} />
