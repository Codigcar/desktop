...
import Profile from '../Profile.v2'
...
describe('Profile screen page', () => {
  ...
  it('should navigate to custom content screen', () => {
    ...
    expect(mockNavigate).toHaveBeenLastCalledWith('CustomContent')
  })
  ...
  it('should navigate to favorites screen', () => {
    ...
    expect(mockNavigate).toHaveBeenLastCalledWith('Favorite')
  })
  ...
  it('should navigate to subscription screen', () => {
    ...
    expect(mockNavigate).toHaveBeenLastCalledWith('Subscription')
  })
  ...
  it('should navigate to notification screen', () => {
    const { getByText } = render(<Profile />)
