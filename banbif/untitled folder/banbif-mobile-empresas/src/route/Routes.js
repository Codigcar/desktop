...
import { Image, Keyboard, PanResponder, View } from 'react-native'
...
const Routes = () => {
	...
	return (
		<View {...panResponder.panHandlers} style={{ flex: 1, backgroundColor: 'transparent' }}>
					...
					<Stack.Screen
						...
						options={({ navigation, route }) => {
							...
							return {
								...
								headerTitle: () => <Image style={{ width: 110, height: 30, }} source={images.logo}/>,
								headerStyle: {
