  ...
  var ViewContainer = exports.default = function (_Component) {
    (0, _inherits2.default)(ViewContainer, _Component);
    function ViewContainer() {
      (0, _classCallCheck2.default)(this, ViewContainer);
      return _callSuper(this, ViewContainer, arguments);
    }
    (0, _createClass2.default)(ViewContainer, [{
      key: "render",
      value: function render() {
        return (0, _jsxRuntime.jsx)(_reactNative.View, {
          style: [this.props.style, _Styles.default.mainContainer],
