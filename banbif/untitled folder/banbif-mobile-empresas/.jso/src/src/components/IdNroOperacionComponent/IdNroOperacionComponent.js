  ...
  var IdNroOperacionComponent = exports.default = function (_Component) {
    (0, _inherits2.default)(IdNroOperacionComponent, _Component);
    function IdNroOperacionComponent() {
      (0, _classCallCheck2.default)(this, IdNroOperacionComponent);
      return _callSuper(this, IdNroOperacionComponent, arguments);
    }
    (0, _createClass2.default)(IdNroOperacionComponent, [{
      key: "render",
    ...
    return IdNroOperacionComponent;
  }(_react.Component);
  IdNroOperacionComponent.proptype = {
