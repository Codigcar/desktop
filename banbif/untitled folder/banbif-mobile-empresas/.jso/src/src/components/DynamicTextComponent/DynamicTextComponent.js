  ...
  var DynamicTextComponent = exports.default = function (_Component) {
    (0, _inherits2.default)(DynamicTextComponent, _Component);
    function DynamicTextComponent() {
      (0, _classCallCheck2.default)(this, DynamicTextComponent);
      return _callSuper(this, DynamicTextComponent, arguments);
    }
    (0, _createClass2.default)(DynamicTextComponent, [{
      key: "render",
      value: function render() {
        return (0, _jsxRuntime.jsx)(_reactNative.View, {
          children: (0, _jsxRuntime.jsx)(_reactNative.Text, {
            style: _Styles.default.text,
            children: this.props.dynamicText
          })
        });
      }
    }]);
