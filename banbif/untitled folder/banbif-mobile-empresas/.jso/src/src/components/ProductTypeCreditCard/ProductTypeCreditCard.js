  ...
  var ProductTypeCreditCard = exports.default = function (_Component) {
    (0, _inherits2.default)(ProductTypeCreditCard, _Component);
    function ProductTypeCreditCard() {
      (0, _classCallCheck2.default)(this, ProductTypeCreditCard);
      return _callSuper(this, ProductTypeCreditCard, arguments);
    }
    (0, _createClass2.default)(ProductTypeCreditCard, [{
      key: "render",
            ...
            children: [(0, _jsxRuntime.jsxs)(_reactNative.View, {
              ...
              children: [(0, _jsxRuntime.jsx)(_reactNative.View, {
                ...
                children: (0, _jsxRuntime.jsx)(_reactNative.Text, {
                  ...
                  children: this.props.nrProducto.length > 4 ? "*".repeat(this.props.nrProducto.length - 4) + this.props.nrProducto.slice(this.props.nrProducto.length - 4, this.props.nrProducto.length) : this.props.NrAccount
                })
              })]
            }), (0, _jsxRuntime.jsxs)(_reactNative.View, {
              style: _Style.default.titleContainer,
              children: [(0, _jsxRuntime.jsx)(_reactNative.View, {
                ...
                children: (0, _jsxRuntime.jsx)(_reactNative.Text, {
                  style: [_Style.default.accountFont, {
                    color: this.props.saldo > 0 ? _colors.default.green : _colors.default.red
                  }],
                  children: _monetaryType.default[this.props.moneda] + _monetary.Monetary.format(this.props.saldo)
                })
              })]
