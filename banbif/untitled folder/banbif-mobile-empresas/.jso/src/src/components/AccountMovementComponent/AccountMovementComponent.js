  ...
  var _InterleavedListMovementComponent = _interopRequireDefault(_$$_REQUIRE(_dependencyMap[12]));
  var _monetaryType = _interopRequireDefault(_$$_REQUIRE(_dependencyMap[13]));
  var _monetary = _$$_REQUIRE(_dependencyMap[14]);
  ...
  var AccountMovementComponent = exports.default = function (_Component) {
    (0, _inherits2.default)(AccountMovementComponent, _Component);
    function AccountMovementComponent() {
      var _this;
      (0, _classCallCheck2.default)(this, AccountMovementComponent);
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      _this = _callSuper(this, AccountMovementComponent, [].concat(args));
    ...
    (0, _createClass2.default)(AccountMovementComponent, [{
      key: "render",
        ...
        return (0, _jsxRuntime.jsxs)(_reactNative.View, Object.assign({}, this.props, {
          children: [(0, _jsxRuntime.jsxs)(_reactNative.View, {
            ...
            children: [(0, _jsxRuntime.jsx)(_reactNative.Text, {
              ...
              children: ["Monto ", _monetaryType.default[this.props.Currency]]
            })]
            ...
            children: (0, _jsxRuntime.jsxs)(_reactNative.View, {
              ...
              children: [(0, _jsxRuntime.jsx)(_reactNative.ActivityIndicator, {
                ...
                renderItem: function renderItem(_ref) {
                  var item = _ref.item,
                    index = _ref.index;
                  return (0, _jsxRuntime.jsx)(_InterleavedListMovementComponent.default, {
                    BackgroundColor: !(index % 2 == 0) ? _colors.default.listGrey : _colors.default.white,
                    Day: !(item.fechaMovimiento == undefined) ? _dateFormat.DateFormat.formatMonthName(item.fechaMovimiento) : "",
                    History: item.descripcion,
                    Doa: item.numeroOperacion,
                    Value: item.esDebito ? _monetary.Monetary.format(-item.montoMovimiento) : _monetary.Monetary.format(item.montoMovimiento),
    ...
    return AccountMovementComponent;
  }(_react.Component);
