  ...
  var BlueLineWithTextComponent = exports.default = function (_Component) {
    (0, _inherits2.default)(BlueLineWithTextComponent, _Component);
    function BlueLineWithTextComponent() {
      (0, _classCallCheck2.default)(this, BlueLineWithTextComponent);
      return _callSuper(this, BlueLineWithTextComponent, arguments);
    }
    (0, _createClass2.default)(BlueLineWithTextComponent, [{
      key: "render",
      value: function render() {
        return (0, _jsxRuntime.jsx)(_reactNative.View, Object.assign({}, this.props, {
          style: _Styles.default.ViewColor,
    ...
    return BlueLineWithTextComponent;
  }(_react.Component);
