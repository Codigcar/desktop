  ...
  var ProductTypeDiscounts = exports.default = function (_Component) {
    (0, _inherits2.default)(ProductTypeDiscounts, _Component);
    function ProductTypeDiscounts() {
      (0, _classCallCheck2.default)(this, ProductTypeDiscounts);
      return _callSuper(this, ProductTypeDiscounts, arguments);
    }
    (0, _createClass2.default)(ProductTypeDiscounts, [{
      key: "render",
