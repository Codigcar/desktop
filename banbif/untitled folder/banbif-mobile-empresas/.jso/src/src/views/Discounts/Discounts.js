  ...
  var _DiscountsNumberComponent = _interopRequireDefault(_$$_REQUIRE(_dependencyMap[12]));
  ...
  var Discounts = exports.default = function (_Component) {
    (0, _inherits2.default)(Discounts, _Component);
    function Discounts(props) {
      var _this;
      (0, _classCallCheck2.default)(this, Discounts);
      _this = _callSuper(this, Discounts, [props]);
      _this.state = {
        spinner: false,
        size: 0,
        list: true,
    ...
    (0, _createClass2.default)(Discounts, [{
      key: "hasMessage",
      ...
      value: function render() {
        ...
        return (0, _jsxRuntime.jsxs)(_reactNative.View, {
          ...
          children: [(0, _jsxRuntime.jsx)(_DiscountsNumberComponent.default, {
