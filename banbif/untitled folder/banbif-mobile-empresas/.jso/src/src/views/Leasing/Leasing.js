  ...
  var _ModalErrorComponent = _interopRequireDefault(_$$_REQUIRE(_dependencyMap[12]));
  var _BlueLineWithTextComponent = _interopRequireDefault(_$$_REQUIRE(_dependencyMap[13]));
  var _IdNroOperacionComponent = _interopRequireDefault(_$$_REQUIRE(_dependencyMap[14]));
  ...
  var _dateFormat = _$$_REQUIRE(_dependencyMap[18]);
  var _monetary = _$$_REQUIRE(_dependencyMap[19]);
  ...
  var Leasing = exports.default = function (_Component) {
    (0, _inherits2.default)(Leasing, _Component);
    function Leasing(props) {
      var _this;
      (0, _classCallCheck2.default)(this, Leasing);
      _this = _callSuper(this, Leasing, [props]);
      _this.state = {
        spinner: false,
        size: 0,
        list: true,
    ...
    (0, _createClass2.default)(Leasing, [{
      key: "hasMessage",
      ...
      key: "getLeasingDetails",
      value: function () {
        var _getLeasingDetails = (0, _asyncToGenerator2.default)(function* () {
          this.setState({
            spinner: true,
        ...
        function getLeasingDetails() {
          return _getLeasingDetails.apply(this, arguments);
        }
        return getLeasingDetails;
      }()
    }, {
      key: "UNSAFE_componentWillMount",
      value: function () {
        var _UNSAFE_componentWillMount = (0, _asyncToGenerator2.default)(function* () {
          yield this.getLeasingDetails();
        });
      ...
      value: function render() {
        ...
        return (0, _jsxRuntime.jsxs)(_reactNative.View, {
          ...
          children: [(0, _jsxRuntime.jsx)(_IdNroOperacionComponent.default, {
