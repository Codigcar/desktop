  ...
  var _DocumentNumberAndTypeComponent = _interopRequireDefault(_$$_REQUIRE(_dependencyMap[11]));
  ...
  var Factoring = exports.default = function (_Component) {
    (0, _inherits2.default)(Factoring, _Component);
    function Factoring(props) {
      var _this;
      (0, _classCallCheck2.default)(this, Factoring);
      _this = _callSuper(this, Factoring, [props]);
      _this.state = {
        spinner: false,
        size: 0,
        list: true,
    ...
    (0, _createClass2.default)(Factoring, [{
      key: "hasMessage",
      ...
      key: "getFactoringDetails",
      value: function () {
        var _getFactoringDetails = (0, _asyncToGenerator2.default)(function* () {
          this.setState({
            spinner: true,
        ...
        function getFactoringDetails() {
          return _getFactoringDetails.apply(this, arguments);
        }
        return getFactoringDetails;
      }()
    }, {
      key: "UNSAFE_componentWillMount",
      value: function () {
        var _UNSAFE_componentWillMount = (0, _asyncToGenerator2.default)(function* () {
          yield this.getFactoringDetails();
        });
      ...
      value: function render() {
        ...
        return (0, _jsxRuntime.jsxs)(_reactNative.View, {
          ...
          children: [(0, _jsxRuntime.jsx)(_DocumentNumberAndTypeComponent.default, {
