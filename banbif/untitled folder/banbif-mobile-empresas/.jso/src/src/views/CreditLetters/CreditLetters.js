  ...
  var _CreditLettersNumberComponent = _interopRequireDefault(_$$_REQUIRE(_dependencyMap[13]));
  ...
  var CreditLetters = exports.default = function (_Component) {
    (0, _inherits2.default)(CreditLetters, _Component);
    function CreditLetters(props) {
      var _this;
      (0, _classCallCheck2.default)(this, CreditLetters);
      _this = _callSuper(this, CreditLetters, [props]);
      _this.state = {
        spinner: false,
        size: 0,
        list: true,
    ...
    (0, _createClass2.default)(CreditLetters, [{
      key: "hasMessage",
      ...
      key: "getDiscountsDetails",
      value: function () {
        var _getDiscountsDetails = (0, _asyncToGenerator2.default)(function* () {
          this.setState({
            spinner: true,
        ...
        function getDiscountsDetails() {
          return _getDiscountsDetails.apply(this, arguments);
        }
        return getDiscountsDetails;
      }()
    }, {
      key: "UNSAFE_componentWillMount",
      value: function () {
        var _UNSAFE_componentWillMount = (0, _asyncToGenerator2.default)(function* () {
          yield this.getDiscountsDetails();
        });
      ...
      value: function render() {
        ...
        return (0, _jsxRuntime.jsxs)(_reactNative.View, {
          ...
          children: [(0, _jsxRuntime.jsx)(_CreditLettersNumberComponent.default, {
