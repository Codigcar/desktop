...
#ifndef DIDM_SELFID_SWIFT_H
#define DIDM_SELFID_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="didm_selfid",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11didm_selfid8Activity")
...
SWIFT_CLASS("_TtC11didm_selfid12ConstantsSDK")
...
@protocol LivenessResultDelegate;
@class LivenessConfigProperties;
@class NSBundle;
@class NSCoder;

SWIFT_CLASS("_TtC11didm_selfid13FaceAliveView")
@interface FaceAliveView : UIViewController <AVCaptureMetadataOutputObjectsDelegate, AVCaptureVideoDataOutputSampleBufferDelegate>
@property (nonatomic, weak) id <LivenessResultDelegate> _Nullable delegate;
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
@property (nonatomic, readonly) BOOL shouldAutorotate;
- (void)stopProcess;
- (void)settingConfigurationWithConfig:(LivenessConfigProperties * _Nonnull)config;
...
@interface FaceAliveView (SWIFT_EXTENSION(didm_selfid))
...
SWIFT_CLASS("_TtC11didm_selfid13FaceStructure")
...
SWIFT_CLASS("_TtC11didm_selfid12FaceTemplate")
...
typedef SWIFT_ENUM(NSInteger, Gesture, open) {
  GestureNEUTRAL = 0,
  GestureBLINK = 1,
  GestureSIDE_TO_SIDE = 2,
  GestureSMILE = 3,
  GestureOPEN_EYES = 4,
  GestureCLOSED_EYES = 5,
  GestureLEFT = 6,
  GestureRIGHT = 7,
  GestureNONE = 8,
};
...
SWIFT_CLASS("_TtC11didm_selfid14GestureMessage")
@interface GestureMessage : NSObject
@property (nonatomic) enum Gesture gesture;
@property (nonatomic, strong) LivenessGif * _Nonnull gif;
@property (nonatomic, strong) LivenessText * _Nonnull text;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

typedef SWIFT_ENUM(NSInteger, LivenessBlur, open) {
  LivenessBlurEXTRA_LIGHT = 0,
  LivenessBlurLIGHT = 1,
  LivenessBlurDARK = 2,
};


SWIFT_CLASS("_TtC11didm_selfid13LivenessColor")
@interface LivenessColor : NSObject
@property (nonatomic, copy) NSString * _Nonnull colorHex;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class LivenessProgressBar;
@class TipsConfig;

SWIFT_CLASS("_TtC11didm_selfid24LivenessConfigProperties")
@interface LivenessConfigProperties : NSObject
@property (nonatomic) NSInteger challengeDuration;
@property (nonatomic, copy) NSArray<GestureMessage *> * _Nonnull gestures;
@property (nonatomic, strong) LivenessText * _Nonnull successMessage;
@property (nonatomic, strong) LivenessText * _Nonnull nearbyMessage;
@property (nonatomic, strong) LivenessText * _Nonnull exitMessage;
@property (nonatomic, strong) LivenessProgressBar * _Nonnull progressBar;
@property (nonatomic) enum LivenessBlur shapeBackground;
@property (nonatomic, strong) TipsConfig * _Nonnull tipsEnable;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

typedef SWIFT_ENUM(NSInteger, LivenessError, open) {
  LivenessErrorBadConfiguration = 0,
  LivenessErrorNotFoundCamera = 1,
  LivenessErrorPermissionDeny = 2,
};


SWIFT_CLASS("_TtC11didm_selfid11LivenessGif")
@interface LivenessGif : NSObject
@property (nonatomic, copy) NSString * _Nonnull name;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11didm_selfid19LivenessProgressBar")
@interface LivenessProgressBar : NSObject
@property (nonatomic, strong) LivenessColor * _Nonnull color;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class UIImage;

SWIFT_PROTOCOL("_TtP11didm_selfid22LivenessResultDelegate_")
@protocol LivenessResultDelegate
...
@class LivenessTypography;

SWIFT_CLASS("_TtC11didm_selfid12LivenessText")
@interface LivenessText : NSObject
@property (nonatomic) NSInteger size;
@property (nonatomic, strong) LivenessColor * _Nonnull color;
@property (nonatomic, copy) NSString * _Nonnull text;
@property (nonatomic, strong) LivenessTypography * _Nonnull typography;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11didm_selfid18LivenessTypography")
@interface LivenessTypography : NSObject
@property (nonatomic, copy) NSString * _Nonnull name;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC11didm_selfid3SDK")
...
SWIFT_PROTOCOL("_TtP11didm_selfid11SDKDelegate_")
@protocol SDKDelegate
...
SWIFT_CLASS("_TtC11didm_selfid7TipView")
@interface TipView : UIViewController
...
SWIFT_CLASS("_TtC11didm_selfid10TipsConfig")
@interface TipsConfig : NSObject
@property (nonatomic) BOOL enabled;
@property (nonatomic, copy) NSString * _Nonnull nameXib;
@property (nonatomic) double timeShow;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11didm_selfid12TipsHomeView")
@interface TipsHomeView : UIPageViewController
@property (nonatomic, strong) UIColor * _Nonnull color;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC11didm_selfid24UserCommunicationMessage")
